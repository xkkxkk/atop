...
func (h *AuthHandler) Version(c *gin.Context) {
  response.OK(c, gin.H{
    "name":      "atop-backend",
		"version":   envOr("APP_VERSION", "v1.0.24"),
		"latest":    envOr("APP_LATEST_VERSION", envOr("APP_VERSION", "v1.0.24")),
		"buildTime": envOr("BUILD_TIME", "2026-05-22 07:55"),
		"commit":    envOr("GIT_COMMIT", "document-upload-local-preview-20260522"),

...
const FRONTEND_FALLBACK: VersionPayload = {
  ...
  env: 'production',
  status: 'fallback',
  features: ['运行大盘', '运行记录', '全局命令搜索', '流水线运行前检查', '失败归因摘要', '顶部标签管理', '用户与角色管理', '保存筛选视图', '权限变更确认', '通知规则测试', '个人固定标签', '版本提示优化', '版本管理页', '版本管理左侧菜单', 'Jenkins 模板折叠', 'Agent 容量状态收敛', '版本管理页精修', '版本搜索定位与复制修复', '版本管理工作区间距修正', '文档中心能力移除'],
  changes: [

...
export const VERSION_HISTORY: VersionHistoryEntry[] = [
  {
    ...
    time: '07:55',
    title: '文档上传本地真实预览修正',
    desc: '文档中心上传后不再只显示占位说明，docx/pptx 会从 Office XML 抽取文本生成翻页内容，Markdown/TXT 直接读取，图片直接预览；PDF 和旧 Office 格式明确提示需要转码。',
    frontend: {
      channel: 'frontend',
      version: 'v1.0.24',
    ...
    backend: {
      ...
      env: commonEnv,
      changes: [
        '后端版本接口同步返回 v1.0.24 信息；复杂 Office/PDF 完整渲染仍建议后端转码服务接入',
      ],
    },
  },
  {
    ...
    time: '00:20',
    title: '文档类型样式与点击翻书交互',
    desc: '文档中心补齐 PPT、Word、Markdown、PDF、图片、飞书等类型样式，移除上一页/下一页按钮，改为点击左右书页触发 3D 翻书效果。',
    frontend: {
      channel: 'frontend',
      version: 'v1.0.23',
      buildTime: '2026-05-22 00:20',
      commit: 'document-reader-type-styles-page-turn-20260522',
      env: commonEnv,
      changes: [
    ...
    backend: {
      ...
      env: commonEnv,
      changes: [
        '后端版本接口同步返回 v1.0.23 信息；文档真实解析和持久化接口继续预留后续接入',
      ],
    },
  },
  {
    ...
    time: '23:55',
    title: '文档中心与仿真翻页阅读',
    desc: '新增文档中心页面，支持连接飞书/外部文档和上传文件入口，并提供书本式双页预览、轻量翻页动画和按页渲染的性能设计。',
    frontend: {
      channel: 'frontend',
      version: 'v1.0.22',
      buildTime: '2026-05-21 23:55',
      commit: 'document-center-book-reader-20260521',
      env: commonEnv,
      changes: [
    ...
    backend: {
      ...
      env: commonEnv,
      changes: [
        '后端版本接口同步返回 v1.0.22 信息；文档持久化、飞书 OAuth 和文件转码接口预留后续接入',
      ],
    },
  },
  {
